...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Nội dung yêu cầu không được để trống' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Lĩnh vực quan tâm không được để trống' }),
    __metadata("design:type", String)
], CreateContactDto.prototype, "sector", void 0);
