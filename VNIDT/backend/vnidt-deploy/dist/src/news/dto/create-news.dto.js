...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Tên tin tức không được để trống' }),
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Mô tả tin tức không được để trống' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsDateString)({}, { message: 'Thời gian đăng không hợp lệ' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
